        ...
        $sql -> execute();
          ...
          if($sql -> rowCount() > 0){
               ...
               foreach ($sql as $key => $value) {
                  echo '<li><a href='.BASE_URL.$value['CAMINHO_LINK'].' class="collapsible-header"><i class="material icons"><img class="circle responsive-img iconeTemplate" src="'.BASE_URL.$value['CAMINHO_ICONE'].'"></i>'.$value['NOME_MODULO'].'</a></li>';
                }
